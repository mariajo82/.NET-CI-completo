...
namespace FullStackCI.Services
{
    public class BookCommandService : IBookCommandService
    {
        ...
        public async Task<BookDto> CreateBookAsync(CreateBookDto createBookDto)
        {
            ...
            var createdBook = _unitOfWorkRepository._bookCommandRepositor.CreateAsync(book);
        ...
        public async Task<BookDto?> UpdateBookAsync(int id, UpdateBookDto updateBookDto)
        {
            ...
            await _unitOfWorkRepository._bookCommandRepositor.UpdateAsync(book);
            _unitOfWorkRepository.SaveChangesAsync();
        ...
        public async Task<bool> DeleteBookAsync(int id)
        {
            ...
            await _unitOfWorkRepository._bookCommandRepositor.DeleteAsync(id);
            _unitOfWorkRepository.SaveChangesAsync();
